...
public class ProductInfoPage {
	...
	public int getProductImagesCount() {
		int imagesCount = eleUtil.waitForElementsVisible(productImages, AppConstants.DEFAULT_TIMEOUT).size();
	...
	public String addProductToCart() {
		...
		String successMessg = eleUtil.waitForElementVisible(cartSuccessMessg, AppConstants.DEFAULT_TIMEOUT).getText();
